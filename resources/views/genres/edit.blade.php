                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('genres.update', $genre) }}" method="POST" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $genre->name) }}" maxlength="255" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('name')
