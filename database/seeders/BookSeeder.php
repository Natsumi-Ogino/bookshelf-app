    ...
    public function run(): void
    {
        ...
        $books = [
            [
                ...
                'description' => '猫の視点から明治時代の人間社会を風刺的に描いた小説です。',
            ...
            [
                ...
                'description' => '良好な人間関係を築き、人を動かすための原則を紹介する書籍です。',
            ...
            [
                ...
                'description' => '読みやすく保守しやすいコードを書くための実践的な技法を解説します。',
            ...
            [
                ...
                'description' => '主体的に生き、周囲と協力して成果を上げるための習慣を解説します。',
            ...
            [
                ...
                'description' => '正義感の強い青年教師が赴任先で経験する出来事を描いた小説です。',
            ...
            [
                ...
                'description' => '人類の誕生から現代までの歴史を幅広い視点で読み解く書籍です。',
            ...
            [
                ...
                'description' => '保守しやすいコードを作るための原則と実践方法を解説します。',
            ...
            [
                ...
                'description' => '他者の評価に縛られずに生きる考え方を対話形式で解説します。',
            ...
            [
                ...
                'description' => '若手芸人の交流と葛藤を通して、夢と現実を描いた小説です。',
            ...
            [
                ...
                'description' => 'データを正しく読み取り、世界を事実に基づいて理解する方法を解説します。',
            ...
            [
                ...
                'description' => '海上輸送用コンテナが世界経済に与えた影響を描いた書籍です。',
        ...
        foreach ($books as $bookData) {
            ...
            $genreIds = array_map(
                fn (string $genreName): int => Genre::query()
